...
@PermitAll
@Route(value = "Motivation", layout = MainLayout.class) // <1>
@PageTitle("Motivation | Habit Tracker")
public class Motivation extends VerticalLayout {
	/**
	 * 
	 */
	...
	public Motivation(CrmService service) { // <2>
	...
	private Component getContactStats() {
		Span stats = new Span(service.countContacts() + " Habits and counting!"); // <4>
	...
	private Chart getCompaniesChart() {
		...
		service.findAllCompanies()
				.forEach(company -> dataSeries.add(new DataSeriesItem(company.getName(), company.getEmployeeCount()))); // <5>
	...
	private final String[] motivationalQuotes = {
			...
			"You miss 100% of the shots you don't take.", "The only way to do great work is to love what you do.",
