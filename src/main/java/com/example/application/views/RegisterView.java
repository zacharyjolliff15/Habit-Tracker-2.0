...
public class RegisterView extends VerticalLayout {
     ...
     */
    public RegisterView(@Autowired UserDetailsService service) throws ServiceException {
        ...
        // Avatar avatarField = new Avatar("Select Avatar image");
        ...
        Button submitButton = new Button("Register To Habit Tracker");
        ...
        formLayout.setColspan(handleField,2);
        ...
        add(formLayout);
        add(new RouterLink("Click Here to Login", LoginView.class));
        ...
        submitButton.addClickListener(e -> {
            ...
            } catch (com.example.application.views.data.UserDetailsService.ServiceException e1) {
